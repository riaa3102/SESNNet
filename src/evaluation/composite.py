# Source: https://github.com/santi-pdp/segan_pytorch/blob/master/segan/utils.py
...
def PESQ(ref_wav, deg_wav):
    ...
    # Compute PESQ metric
    wb_pesq = pesq(16000, ref_wav, deg_wav, 'wb')
    return wb_pesq
...
def CompositeEval(ref_wav, deg_wav, log_all=False):
    ...
    # Compute the PESQ
    pesq_raw = float(PESQ(ref_wav, deg_wav))
